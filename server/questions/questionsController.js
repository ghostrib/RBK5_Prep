...
module.exports = {
              ...
              Lecture.update(
                ...
                function(err, questionLecture) {
                  if (err) {
                    ...
                    res.send({
                      lectureModifeied: questionLecture,
                      question: question
                    });
                  }
                }
  ...
  editQuestion: function(req, res, next) {
    ...
    Question.update({ _id: questionID }, { $set: data }, function(
      err,
      modifiedQues
    ) {
      if (err) {
  ...
  getQuestion: function(req, res, next) {
    ...
    Question.findOne({ _id: questionID }, function(err, questionFound) {
      if (err) {
  ...
  getAllLectureQuestions: function(req, res, next) {
    ...
    Question.find({ lectureID: lectureID }, function(err, questions) {
      if (err) {
